...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`ordenproduccion` (
  ...
  `Ordenprod_created_at` TIMESTAMP GENERATED ALWAYS AS ()  COMMENT 'Registra el tiempo de creacion de la tupla',
  ...
  `ordenproduccioncol` VARCHAR(45) NULL DEFAULT '1',
