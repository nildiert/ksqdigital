...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`cliente` (
  ...
  `CliEstado` TINYINT(1) NULL DEFAULT NULL COMMENT 'Este campo se utiliza para establecer si esta activo o inactivo el valor',
  PRIMARY KEY (`Cliid`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`insumos` (
  ...
  `InsEstado` TINYINT(1) NULL DEFAULT NULL COMMENT 'Este campo se utiliza para establecer si esta activo o inactivo el valor',
...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`ordencompra` (
  ...
  `OrdComEstado` TINYINT(1) NULL DEFAULT NULL COMMENT 'Este campo se utiliza para establecer si esta activo o inactivo el valor',
...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`insordcom` (
  ...
  `InsordcomEstado` TINYINT(1) NULL DEFAULT NULL COMMENT 'Este campo se utiliza para establecer si esta activo o inactivo el valor',
...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`productos` (
  ...
  `ProdEstado` TINYINT(1) NULL DEFAULT NULL COMMENT 'Este campo se utiliza para establecer si esta activo o inactivo el valor',
...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`ordenproduccion` (
  ...
  `OrdenprodEstado` TINYINT(1) NULL DEFAULT NULL COMMENT 'Este campo se utiliza para establecer si esta activo o inactivo el valor',
...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`proins` (
  ...
  `ProinsEstado` TINYINT(1) NULL DEFAULT NULL COMMENT 'Este campo se utiliza para establecer si esta activo o inactivo el valor',
...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`proveedor` (
  ...
  `ProvEstado` TINYINT(1) NULL DEFAULT NULL COMMENT 'Este campo se utiliza para establecer si esta activo o inactivo el valor',
...
CREATE TABLE IF NOT EXISTS `ksqdigital`.`provins` (
  ...
  `ProvinsEstado` TINYINT(1) NULL DEFAULT NULL COMMENT 'Este campo se utiliza para establecer si esta activo o inactivo el valor',
